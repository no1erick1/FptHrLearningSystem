...
$('body').append('' +
    '<div class="fixed-button">' +
        '<a href="https://www.facebook.com/Thanh.Duong.2812/" target="_blank" class="btn btn-md btn-primary">' +
            '<i class="fa fa-facebook-official" aria-hidden="true"></i> My Contact' +
        '</a> ' +
    '</div>' +
'');
var $window = $(window);
